...
be the witness of \eqref{eq:E1} at index $i$; note $x^{(i)}_{n+1}\in C'$. Let
$\vec y\in R\cap(C\times B_1\times\cdots\times B_n\times A_{n+1})$ have
...
A formalization should therefore prove ($\ddagger$) as a standalone lemma
quantified over both arguments, rather than as an assertion about the
particular $b$ fixed in Step~2 --- the latter is the form in which the source
states it, and it does not suffice for the second application.
\end{remark}
