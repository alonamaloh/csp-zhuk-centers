...
Given a family of algebras $(\bA_i)_{i\in I}$ indexed by a set $I$, the product
algebra $\prod_{i\in I}\bA_i$ has universe $\prod_{i\in I}A_i$ and operations
...
The index set is deliberately arbitrary: Theorem~\ref{thm:relational-absorption}
forms $\bA^{A^m}$ and projects it onto a subset of $A^m$, so the constructions of
Lemma~\ref{lem:pp} must be available for index sets that are not initial
segments of the naturals.
\end{definition}
...
Let $(\bA_i)_{i\in I}$ be a family of algebras indexed by a set $I$.
\begin{enumerate}\alphlabels\tightlist
...
Lemma~\ref{lem:hom-image}(a) applies. Nothing in (a)--(e) uses finiteness of
$I$ or an ordering of it.
\end{proof}
...
Definition~\ref{def:product}\newline\emph{Products} & Theorem~\ref{thm:relational-absorption} and Lemma~\ref{lem:pp} \\
...
\item homomorphisms, the compatibility of images with generation, and the
      five relational constructions of Lemma~\ref{lem:pp}: intersection, box
